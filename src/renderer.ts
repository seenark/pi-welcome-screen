 ...
 */
export function resolveColorMarkers(line: string, colorMap: Record<string, string>): string {
 ...
 */
export function buildAnimationColorMap(baseColorName: string): Record<string, string> {
  ...
  map["base"] = colorToAnsi(baseColorName);
  return map;
}
...
const RAINBOW_COLORS = [
  "red", "peach", "yellow", "green", "teal", "sapphire", "blue", "lavender", "pink", "mauve",
];
